...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;"  class="default-q" id="buyer_id" name="buyer_id" value="9187437611" tooltiptext="用户ID（UID）<br>不可空"/>
    <br>
    </td>
</tr>
...
<tr>
    <td style="vertical-align: top; width: 25%;">买家手机号:
    <br>
    </td>
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;"  class="default-q" id="buyer_mobile" name="buyer_mobile" value="13812345678" tooltiptext="买家的手机号，也是唯一标识之一,不可空"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;"  class="default-q" id="buyer_ip" name="buyer_ip" value="102.112.12.45" tooltiptext="用户在商户平台下单的时候的ip地址，公网IP，不是内网IP,可空<br>202.114.12.45"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="pay_amount_src" name="pay_amount_src" value="0.10" 
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="tradeParam1" name="tradeParam1" value="" tooltiptext="钱包合作商户网站唯一订单号（确保在合作伙伴系统中唯一）。,不可空<br>"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="tradeParam2" name="tradeParam2" value="东风雪铁龙" tooltiptext="商品的标题/交易标题/订单标题/订单关键字等。,不可空<br>"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="tradeParam3" name="tradeParam3" value="0.10" tooltiptext="单位为：RMB Yuan。取值范围为[0.01，1000000.00]，精确到小数点后两位。,不可空<br>"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="tradeParam4" name="tradeParam4" value="1" tooltiptext="商品的数量。,不可空<br>2"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="tradeParam5" name="tradeParam5" value="0.10" tooltiptext="=(商品单价×商品数量),这里的交易金额是商品的原价,既这个价格是扣除订金金额之前的价格,不可空<br>230"/>
    <br>
    </td>
</tr>

<tr>
    <td style="vertical-align: top; width: 25%;">担保金额:
    <br>
    </td>
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" id="tradeParam6" name="tradeParam6" value="0.05" tooltiptext="<=交易金额,不可空<br>230"/>
    <br>
    </td>
</tr>
...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input type="hidden" style="width: 100%;" id="tradeParam8" name="tradeParam8" value="UID" tooltiptext="表明ID的类型,固定值：UID,不可空<br>UID"/>
