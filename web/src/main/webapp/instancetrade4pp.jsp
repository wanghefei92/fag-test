...
<head>
    ...
    <title>即时到账交易测试页面（APP）</title>
</head>
<body>
<div id="mainContainer">
    <h1>即时到账交易测试页面（APP）</h1>
    <fieldset>
        <legend>
            介绍
        </legend>
        ...
        <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" class="default-q" id="request_no" name="request_no" value="c009"
                           tooltiptext="钱包合作商户请求号,不可空<br>订单编号：20131105154925">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" class="default-q" id="trade_list" name="trade_list" value="不可空"
                           tooltiptext="参见“2.3.2交易参数”,参数按表中的顺序，商品参数间用”~”间隔，每批商品用”$”间隔。如果有中间的参数为空，需要用”~”占位。建议商品数量不超过5个。<br>不可空">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" class="default-q" id="buyer_id" name="buyer_id" value="9187437611"
                           tooltiptext="不可空(匿名支付可空)">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" class="default-q" id="buyer_mobile" name="buyer_mobile"
                           value="13812345678" tooltiptext="不可空(匿名支付可空)<br>MOBILE">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" class="default-q" id="buyer_ip" name="buyer_ip" value="102.122.12.45"
                           tooltiptext="用户在商户平台下单的时候的ip地址，公网IP，不是内网IP;用于风控校验,可空<br>202.114.12.45">
                    <br>
                </td>
            </tr>
    ...
    <fieldset>
        ...
        <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" class="default-q" type="hidden" id="pay_method" name="pay_method"
                           value=""/>
                    <input style="width: 100%;" id="pay_method_src" name="pay_method_src" value="online_bank"
                           tooltiptext="取值范围：pos（POS支付）online_bank (网银支付)，如果不设置支付方式，默认识跳转收银台，在收银台选择支付渠道"
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="pay_amount_src" name="pay_amount_src" value="0.20"
                           tooltiptext="单位为：RMB Yuan。取值范围为[0.01，1000000.00]，精确到小数点后两位。,不可空。"
                           onchange="changePayMethod()"/>
                    <br>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="pay_ext_src" name="pay_ext_src" value="TESTBANK,C,DC"
                           tooltiptext="pos支付备注为：操作员ID，现金存根号<br>网银支付备注为：银行号，对公/对私，借记/贷记(对公/对私：B/C;借记/贷记：DC=借记，CC=贷记，GC=综合) 必须注意区分大小写。"
                           onchange="changePayMethod()"/>
                    <br>
                </td>
            </tr>
    ...
    <fieldset>
        ...
        <input style="height: 40px;width: 150px;" type="button" value="新的交易信息" id="newAssembledTradeInfo"
               onclick='newTradeInfo("trade_list","~");'>
        <input style="height: 40px;width: 150px;" type="button" value="添加交易信息" id="addAssembledTradeInfo"
               onclick='addTradeInfo("trade_list","~","$");'>
        <input style="height: 40px;width: 150px;" type="button" value="显示交易信息" id="viewAssembledTradeInfo"
               onclick='alert(assembleTradeInfo("$"));'>
        <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
            <tbody>
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam1" name="tradeParam1" value="2013112405056743"
                           tooltiptext="钱包合作商户网站唯一订单号（确保在合作伙伴系统中唯一）。,不可空<br>2013112405056743">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam2" name="tradeParam2" value="东风雪铁龙"
                           tooltiptext="商品的标题/交易标题/订单标题/订单关键字等。该参数最长为128个汉字。,不可空<br>油漆">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam3" name="tradeParam3" value="0.10"
                           tooltiptext="单位为：RMB Yuan。取值范围为[0.01，1000000.00]，精确到小数点后两位。,不可空<br>115">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam4" name="tradeParam4" value="2"
                           tooltiptext="商品的数量。,不可空<br>2">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam5" name="tradeParam5" value="0.20"
                           tooltiptext="#NAME?,不可空<br>230">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam6" name="tradeParam6" value=""
                           tooltiptext="参见“2.3.4 royalty_parameters参数说明”。,可空<br>参见“2.3.4 royalty_parameters参数说明”">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam7" name="tradeParam7" value="9187437612"
                           tooltiptext="用户ID（UID）<br>不可空">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input type="hidden" style="width: 100%;" id="tradeParam8" name="tradeParam8" value="UID"
                           tooltiptext="表明ID的类型,UID,不可空<br>UID">
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam9" name="tradeParam9" value="13855462942"
                           tooltiptext="卖家手机号,不可空">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam10" name="tradeParam10" value="爱丽舍-三厢 1.6 MT"
                           tooltiptext="对一笔交易的具体描述信息。如果是多种商品，请将商品描述字符串累加传给body。,可空<br>白色墙面漆 5KG">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam11" name="tradeParam11"
                           value="http://www.test.com/?product-9.html"
                           tooltiptext="收银台页面上，商品展示的超链接。,可空<br>http://www.test.com/?product-9.html">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam12" name="tradeParam12" value="20140526090530"
                           tooltiptext="数字串，一共14位格式为：年[4位]月[2位]日[2位]时[2位]分[2位]秒[2位] ,可空<br>0">
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam13" name="tradeParam13"
                           value="<%= tpuUrl %>/mag/asynNotify.do" tooltiptext="异步通知调用方，表示成功或失败,不可空<br>http://*.com/tpu/mag/asynNotify.do"/>
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam14" name="tradeParam14" value="7d"
                           tooltiptext="设置未付款交易的超时时间，一旦超时，该笔交易就会自动被关闭。取值范围：1m～15d。m-分钟，h-小时，d-天。该参数数值不接受小数点，如1.5h，可转换为90m。可空">
                    <br>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top; width: 75%;">
                    <input style="width: 100%;" id="tradeParam15" name="tradeParam15" value="上海大众4S店"
                           tooltiptext="具体交易发生的店铺名称。可空">
                    <br>
                </td>
            </tr>
