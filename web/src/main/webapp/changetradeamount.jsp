       ...
       <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
           <tbody>
				...
				<tr>
				    ...
				    <td style="vertical-align: top; width: 75%;">
				    <input style="width: 100%;" class="default-q" id="total_amount" name="total_amount" value="10.00" tooltiptext="新的交易金额"/>
				    <br>
				    </td>
				</tr>
				...
				<tr>
				    ...
				    <td style="vertical-align: top; width: 75%;">
				    <input style="width: 100%;" class="default-q" id="ensure_amount" name="ensure_amount" value="" tooltiptext="担保金额"/>
				    <br>
				    </td>
				</tr>
