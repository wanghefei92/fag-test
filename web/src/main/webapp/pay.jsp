...
<tr>
    ...
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" class="default-q" id="pay_method" name="pay_method" value="" tooltiptext="取值范围： cash（现金），pos（POS支付）， online_bank(网银支付)，balance(余额),可空<br>cash^25.00^操作员ID(必填)|pos^100.00^|balance^25.00^|online_bank ^75.00^银行编码"/>
    <br>
    </td>
</tr>
...
<tr>
	    ...
	    <td style="vertical-align: top; width: 75%;">
	        <input style="width: 100%;" class="default-q" id="is_web_access" name="is_anonymous" value="N" tooltiptext="取值有以下情况：Y，匿名支付 ，N（默认），登录收银台支付<br>"/>
	    <br>
	    </td>
	</tr>
