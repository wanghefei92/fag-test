...
<tr>
    <td style="vertical-align: top; width: 25%;">交易取消原因:
    <br>
    </td>
    <td style="vertical-align: top; width: 75%;">
    <input style="width: 100%;" class="default-q" id="reason" name="reason" value="交易取消" tooltiptext="描述交易取消的原因"/>
    <br>
    </td>
</tr>
